...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n  font-family: \"Roboto\" sans-serif;\n}\n\n.icon {\n  display: grid;\n  place-items: center;\n}\n\nbody {\n  width: 100vw;\n  height: 100vh;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n\nnav {\n  position: absolute;\n  bottom: 0;\n  width: 80%;\n  display: flex;\n  align-items: flex-end;\n  gap: 10px;\n}\nnav a {\n  flex: 1;\n}\nnav a button {\n  width: 100%;\n}\nnav .add-habit {\n  flex: 0 0 50px;\n  height: 50px;\n  font-size: 2.5rem;\n}\n\n.dialog-container {\n  position: fixed;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  z-index: 2;\n}\n\n.dialog-container[aria-hidden=true] {\n  display: none;\n}\n\n.dialog-overlay {\n  position: fixed;\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0;\n  background-color: rgba(43, 46, 56, 0.692);\n}\n\n.dialog-content {\n  background-color: rgb(255, 255, 255);\n  z-index: 2;\n  position: relative;\n}\n\n#pick-habit .dialog-content {\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  align-self: flex-end;\n  border-radius: 10px 10px 0 0;\n  background-color: transparent;\n}\n#pick-habit .habit-type {\n  background-color: rgba(0, 0, 0, 0.849);\n  color: white;\n  border: none;\n  margin: 0;\n  padding: 0;\n  display: grid;\n  grid-template-columns: 40px 1fr 40px;\n  grid-template-rows: repeat(2, 40px);\n  grid-template-areas: \"icon title leading-arrow\" \"icon description leading-arrow\";\n  gap: 0 10px;\n  place-items: center;\n}\n#pick-habit .habit-type .icon {\n  grid-area: icon;\n  color: aquamarine;\n}\n#pick-habit .habit-type .title {\n  grid-area: title;\n  justify-self: start;\n}\n#pick-habit .habit-type .leading-arrow {\n  grid-area: leading-arrow;\n  align-self: stretch;\n}\n#pick-habit .habit-type .description {\n  grid-area: description;\n  justify-self: start;\n}\n#pick-habit .habit-type:first-child {\n  border-radius: 10px 10px 0 0;\n}", "",{"version":3,"sources":["webpack://./src/main.scss"],"names":[],"mappings":"AACA;EACI,gCAAA;AACJ;;AACA;EACI,aAAA;EACA,mBAAA;AAEJ;;AACA;EACI,YAAA;EACA,aAAA;EAEA,aAAA;EACA,sBAAA;EACA,mBAAA;AACJ;;AAEA;EACI,kBAAA;EACA,SAAA;EAEA,UAAA;EAEA,aAAA;EACA,qBAAA;EACA,SAAA;AADJ;AAGI;EACI,OAAA;AADR;AAGQ;EACI,WAAA;AADZ;AAKI;EACI,cAAA;EAEA,YAAA;EAEA,iBAAA;AALR;;AASA;EACI,eAAA;EACA,aAAA;EACA,uBAAA;EACA,mBAAA;EAEA,MAAA;EACA,SAAA;EACA,OAAA;EACA,QAAA;EACA,UAAA;AAPJ;;AAUA;EACI,aAAA;AAPJ;;AAUA;EACI,eAAA;EACA,MAAA;EACA,OAAA;EACA,SAAA;EACA,QAAA;EACA,yCAAA;AAPJ;;AAUA;EACI,oCAAA;EACA,UAAA;EACA,kBAAA;AAPJ;;AAYI;EACI,WAAA;EAEA,aAAA;EACA,sBAAA;EAEA,oBAAA;EACA,4BAAA;EACA,6BAAA;AAXR;AAcI;EACI,sCAAA;EACA,YAAA;EAEA,YAAA;EACA,SAAA;EACA,UAAA;EAEA,aAAA;EACA,oCAAA;EACA,mCAAA;EACA,gFACA;EAEA,WAAA;EACA,mBAAA;AAhBR;AAkBQ;EACI,eAAA;EACA,iBAAA;AAhBZ;AAmBQ;EACI,gBAAA;EACA,mBAAA;AAjBZ;AAoBQ;EACI,wBAAA;EACA,mBAAA;AAlBZ;AAqBQ;EACI,sBAAA;EACA,mBAAA;AAnBZ;AAuBI;EACI,4BAAA;AArBR","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Roboto&display=swap');\n:root {\n    font-family: 'Roboto' sans-serif;\n}\n.icon {\n    display: grid;\n    place-items: center;\n}\n\nbody {\n    width: 100vw;\n    height: 100vh;\n\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n}\n\nnav {\n    position: absolute;\n    bottom: 0;\n\n    width: 80%;\n\n    display: flex;\n    align-items: flex-end;\n    gap: 10px;\n\n    a {\n        flex: 1;\n\n        button {\n            width: 100%;\n        }\n    }\n\n    .add-habit {\n        flex: 0 0 50px;\n\n        height: 50px;\n\n        font-size: 2.5rem;\n    }\n}\n\n.dialog-container {\n    position: fixed;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n\n    top: 0;\n    bottom: 0;\n    left: 0;\n    right: 0;\n    z-index: 2;\n}\n\n.dialog-container[aria-hidden='true'] {\n    display: none;\n}\n\n.dialog-overlay {\n    position: fixed;\n    top: 0;\n    left: 0;\n    bottom: 0;\n    right: 0;\n    background-color: rgba(43, 46, 56, 0.692);\n}\n\n.dialog-content {\n    background-color: rgb(255, 255, 255);\n    z-index: 2;\n    position: relative;\n}\n\n#pick-habit {\n\n    .dialog-content {\n        width: 100%;\n\n        display: flex;\n        flex-direction: column;\n\n        align-self: flex-end;\n        border-radius: 10px 10px 0 0;\n        background-color: transparent;\n    }\n\n    .habit-type {\n        background-color: rgba(0, 0, 0, 0.849);\n        color: white;\n\n        border: none;\n        margin: 0;\n        padding: 0;\n\n        display: grid;\n        grid-template-columns: 40px 1fr 40px;\n        grid-template-rows: repeat(2,40px);\n        grid-template-areas: \n        \"icon title leading-arrow\"\n        \"icon description leading-arrow\";\n        gap: 0 10px;\n        place-items: center;\n\n        .icon {\n            grid-area: icon;\n            color: aquamarine;\n        }\n\n        .title {\n            grid-area: title;\n            justify-self: start;\n        }\n\n        .leading-arrow {\n            grid-area: leading-arrow;\n            align-self: stretch;\n        }\n\n        .description {\n            grid-area: description;\n            justify-self: start;\n        }\n    }\n\n    .habit-type:first-child {\n        border-radius: 10px 10px 0 0;\n    }\n}\n\n@media only screen and (max-width: 425px) {\n    \n}\n\n\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
const habitsController = (function(){
    function changeHabitState(event){
        ...
        if(event.target.checked){
            habit.markedDays[(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(),"yyyyMMdd")] = true;
        } else {
            delete habit.markedDays[(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(),"yyyyMMdd")];
        }
...
const DOMController = (function(){
    ...
    function generateTodayPage(){
        ...
        header.textContent = `Today is ${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(),"yyyy.MM.dd")}`;
    ...
    function generateTodayHabits(){
        ...
        Model.habits.forEach(habit => {
            ...
            if(true){
                ...
                checkbox.checked = habit.markedDays[(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(),"yyyyMMdd")];
